...
This directory contains Architecture Decision Records (ADRs) for OSM-Notes-Monitoring.
...
- [ADR-0002](0002_Centralized_Monitoring_Repository.md): Centralized Monitoring Repository
- [ADR-0003](0003_Use_Bash_For_Monitoring_Scripts.md): Use Bash for Monitoring Scripts
